...
from study.api.admin import router as admin_router
from study.api.router import router as evaluation_router
...
def test_the_admin_study_routes_are_all_reachable():
