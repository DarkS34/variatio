...
const filterQuery = (filters: EvaluationFilters) => {
...
export const evaluationApi = {
  ...
  // statistical unit of the evaluation.
  ...
  adminEvaluations: (filters: EvaluationFilters) =>
    request<AdminEvaluations>(`/api/admin/evaluations${filterQuery(filters)}`),
  adminEvaluationCsvUrl: (filters: EvaluationFilters) =>
  ...
  adminStageEvaluations: (filters: EvaluationFilters) =>
    request<AdminStageEvaluations>(`/api/admin/evaluations/stages${filterQuery(filters)}`),
  adminStageCsvUrl: (filters: EvaluationFilters) =>
