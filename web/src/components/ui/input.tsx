...
// padding leaves 18 px for a `text-sm` line that needs 20, so every input and every select
...
const field =
  "flex w-full rounded-md border border-input bg-background px-3 text-sm shadow-none transition-colors placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:cursor-not-allowed disabled:opacity-50";
