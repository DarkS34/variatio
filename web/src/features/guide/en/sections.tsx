    ...
    <div className="space-y-6">
      ...
      <Block title="Before launching, what the syllabus is about to tell the model">
        ...
        <Paragraph>
          ...
          exercises can illustrate — prerequisites with no example are not drawn either — and its
          foot says how many it is leaving out; «All concepts», in the selector's header,
