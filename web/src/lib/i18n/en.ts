...
export const en: Catalogue = {
  ...
  "eval.scenario.label": "Scenario (optional)",
  "eval.scenario.placeholder": "A veterinary clinic manages appointments and vaccinations",
  "eval.scenario.hint": "One sentence setting the exercise, the same for both proposals. Left empty, one is drawn and both receive it alike.",
