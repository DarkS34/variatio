...
export const en: Catalogue = {
  ...
  "bank.orderByDifficulty": "Order by difficulty",
  ...
  "modality.difficulty.hint": "Every type uses these same three levels, so «advanced» means the same thing across the whole list and the list can be ordered by it. What changes from one type to the next is what puts an exercise on each level, and that is what you write here. For each level, say how you can tell: what it asks for, how many steps it chains, how much has to be combined. The scale is measured against your own exercises, not against an ideal course.",
