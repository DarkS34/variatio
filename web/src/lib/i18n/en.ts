...
export const en: Catalogue = {
  ...
  "tutorial.s3.step3":
    "From your notes it pulls out the subject's syllabus: the concepts it covers, with their dependencies and relations. That is what makes it possible, when the time comes, to decide what can be taken as known and what cannot — when writing a new exercise, for instance.",
  "tutorial.s3.step4":
  ...
  "stage.what.graph":
    "This is your subject's syllabus as it has been pulled out of your notes: its concepts, grouped into units and joined by what has to be known before what. Go through the concepts, look at what each one relates to, and press any of them to read its description. At the end you are asked to rate this step.",
  "stage.what.bank":
