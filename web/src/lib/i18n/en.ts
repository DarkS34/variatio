...
export const en: Catalogue = {
  ...
  "cfg.section.offeredDesc": "Which model the exercises are written with: the first of the list. The rest are reserved and cannot be deleted off the disk.",
  ...
  "cfg.offered.hint": "The first of the list writes every exercise: nobody picks a model when asking for one. Use «Move to first» to change it. Offering a model does not download it, but it does stop «Engine» from deleting it off the disk.",
