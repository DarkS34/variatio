...
export const en: Catalogue = {
  ...
  "activity.fewShot.none": "No exercises of yours of this type: written with no example to imitate",
  "activity.fewShot.used": { one: "1 exercise of yours used as an example", other: "{n} exercises of yours used as examples" },
