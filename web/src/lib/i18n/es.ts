...
export const es = {
  ...
  "workspace.nameRequired": "Ponle un nombre a la asignatura para poder crearla.",
  ...
  "pipe.sharedNote": "Leer los documentos es un paso aparte y anterior a los tres constructores: los tres lo comparten, así que estos tres ajustes valen para todos.",
  ...
  "cfg.notEditable": "Este ajuste no se cambia desde el panel: se edita en «config.json» y se aplica al reiniciar. El porqué está en «Por qué este valor».",
