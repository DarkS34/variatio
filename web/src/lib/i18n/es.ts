...
export const es = {
  ...
  "step.eval.arms": "Genera las dos propuestas del mismo encargo —la del sistema y la de la alternativa que sorteó la semilla, RAG o comercial— y las baraja antes de enseñarlas.",
  "step.eval.guardrail": "Pasa el texto libre del encargo por el modelo de guardia antes de que llegue a ninguna de las tres.",
  "step.eval.admissibility": "Decide qué pide el texto libre que ya decide otro control de la pantalla. Se paga una vez y las dos propuestas comparten el veredicto.",
  "step.eval.tagging": "Lee las dos propuestas con el mismo etiquetador que el banco, una vez están las dos, y anota qué conceptos usa cada una y cuáles van después en el temario. Es la misma regla que el sistema lleva en su prompt, aplicada a las dos por igual.",
  ...
  "step.eval.arms.label": "Preparando las dos propuestas",
  ...
  "eval.scenario.label": "Escenario (opcional)",
  "eval.scenario.placeholder": "Una clínica veterinaria gestiona citas y vacunas",
  "eval.scenario.hint": "Una frase que ambiente el ejercicio, la misma para las dos propuestas. Si se deja vacío, se sortea uno y las dos lo reciben igual.",
