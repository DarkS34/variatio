...
export const es = {
  ...
  "account.whatIsHere.body":
    "Tu cuenta y lo que es tuyo: los datos con los que entras, los variatios que has generado y las asignaturas a las que tienes acceso. Nada de esto es uno de los cuatro pasos, por eso no está en la barra de arriba.",
  ...
  "job.build_bank.what": "Lee cada documento, lo trocea y recoge los ejercicios, comprobando que encajan con los tipos del Paso 1.2.",
  ...
  "step.check": "Lo que el sistema puede comprobar del variatio sin juzgarlo: si nombra algo no impartido, si se parece demasiado a un ejemplo o a otro del lote, y si el etiquetador lo reconoce como el concepto pedido. Señales para quien lo lee, no un rechazo.",
  ...
  "activity.item.saved": "Ejercicio {index} guardado en «Mis variatios»",
  ...
  "step.generate.label": "Generando variatios",
  "step.check.label": "Comprobando el variatio",
  ...
  "nav.myVariants": "Mis variatios",
  "nav.needsApproved": "Antes hay que terminar la Fase 1: preparar la asignatura",
  ...
  "nav.stepNumber": "Paso {n} · Preparar la asignatura",
  ...
  // mientras el temario preguntaba seis, así que el botón contradecía al formulario que
  ...
  "stage.what.profile.found": {
    one: "Se ha detectado un tipo de ejercicio: {names}.",
    other: "Se han detectado {n} tipos de ejercicio: {names}.",
  },
  "stage.what.profile.more": { one: "1 más", other: "{n} más" },
  "stage.what.profile.why":
    "Es la plantilla con la que se escriben los ejercicios nuevos, así que conviene que te suene.",
  "stage.what.profile.tabs": "Pulsa en cada pestaña para ver los detalles.",
  // La única vez que se dice «grafo» en toda la interfaz, y atada al nombre visible: el
  // artefacto se llama «El temario» en todas partes, pero lo que se está mirando es un
  // grafo y quien lo mira tiene derecho a saberlo. No renombra nada.
  "stage.what.graph":
    "El temario se representa como un grafo de temas: esto es lo que se ha sacado de tus apuntes, agrupado en unidades y unido por lo que hace falta saber antes de cada cosa. Repasa los temas, mira con qué otros se relaciona cada uno y pulsa en cualquiera para leer su descripción. Al final se te pide una valoración de este paso.",
  // DE DÓNDE SALEN LOS TEMAS: del paso anterior. «El tema que practica» escondía justo eso
  // —el único sitio donde se ve por qué el temario va antes que los ejercicios— y además
  // decía uno donde hay varios. Lo demás es el mismo orden que en los otros pasos: qué se
  // está mirando, qué hay que hacer con ello y qué se pide al final.
  "stage.what.bank":
  ...
  "raw.slot.corpus.purpose":
    "Sube los apuntes o los materiales teóricos de la asignatura: guiones, transparencias, el libro. De aquí salen los temas y en qué orden se apoyan unos en otros.",
  ...
  "generations.title": "Variatios guardados",
  ...
  "generate.savedNotice": {
    one: "Este variatio ya está en",
    other: "Estos {n} variatios ya están en",
  },
  "curric.impliedTitle": {
  ...
  "acc.savedVariants": { one: "1 variatio guardado", other: "{n} variatios guardados" },
  ...
  "generations.unreadable": "No se pudieron leer los variatios guardados",
  ...
  "adminStudy.card.rubric": "Rúbrica sobre el variatio del sistema",
  ...
  "kg.noDescription": "Este tema todavía no tiene descripción.",
  ...
  "kg.unreviewed.body": { one: "El único concepto se trata como si sirviera de etiqueta, aunque no identifique nada. Marcarlos decide cuáles descartar, y necesita el Paso 1.2 dado: qué sirve de etiqueta depende de qué forma tienen tus ejercicios.", other: "Los {n} conceptos se tratan como si todos sirvieran de etiqueta, incluidos los que no identifican nada. Marcarlos decide cuáles descartar, y necesita el Paso 1.2 dado: qué sirve de etiqueta depende de qué forma tienen tus ejercicios." },
  ...
  "kg.review.needsProfile":
    "Antes hay que dar por bueno el Paso 1.2: qué sirve de etiqueta depende de qué forma tienen tus ejercicios.",
  ...
  "modality.difficulty.shared":
    "Los peldaños son los mismos en todos los tipos, para que un nivel signifique lo mismo en toda la lista; lo que cambia de un tipo a otro es qué hace que un ejercicio caiga en cada uno, y eso es lo que dice el criterio.",
  ...
  "form.taught.hint": "Si no lo tocas, los ejercicios pueden apoyarse en cualquier tema del temario. Actívalo si la clase va por la mitad: entonces solo se da por sabido lo que marques, y lo de más adelante se queda fuera.",
  ...
  "form.decisions.hint": "Lo que decides tú en vez del modelo. El Paso 1.2 marca qué partes se preguntan aquí; «Cualquiera» se lo deja a él.",
  ...
  "generate.anotherN": "Generar otros {n}",
  "generate.ofRequested": " de {n}",
  "generate.title": "Generar variatios",
  ...
  "cfg.section.generationDesc": "El etiquetador del banco y la generación de variatios: ejemplos few-shot, reintentos y el guardián.",
  ...
  "cfg.pipelineNote": "Cada columna es una construcción y se lee de arriba abajo; cada parada, una llamada al modelo. Bajo el nombre, qué modelo la atiende — cada fase nombra el suyo y ninguna queda vacía; el círculo dice si razona antes de contestar y, mientras razona, el selector de al lado fija su esfuerzo. Razonar y una gramática no conviven en esta pila, así que encender una fase que hoy responde con gramática se la quita y deja la forma en manos del analizador y de la reparación. Tres nodos no dependen de un ajuste: el guardián no razona, el variatio lo decide cada encargo y la reparación es su propia gramática.",
  ...
  "guide.group.prepare": "Preparar la asignatura",
  ...
  "guide.sec.profile": "Paso 1.2 · Tipos de ejercicio",
  "guide.sec.graph": "Paso 1.3 · El temario",
  "guide.sec.bank": "Paso 1.4 · Etiquetado",
  "guide.sec.generate": "Generar variatios",
