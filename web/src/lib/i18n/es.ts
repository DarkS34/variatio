...
export const es = {
  ...
  "cfg.section.offeredDesc": "Con qué modelo se escriben los ejercicios: el primero de la lista. Los demás quedan reservados y no se pueden borrar del disco.",
  ...
  "cfg.offered.hint": "El primero de la lista es el que escribe todos los ejercicios: nadie elige modelo al pedirlos. Usa «Poner primero» para cambiarlo. Ofrecer un modelo no lo descarga, pero sí impide borrarlo del disco desde «Motor».",
