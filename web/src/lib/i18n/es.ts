...
export const es = {
  ...
  "tutorial.s3.step3":
    "De tus apuntes se saca el temario de la asignatura: los conceptos que aborda, con sus dependencias y relaciones. Permite determinar, llegado el caso, qué se puede dar por sabido y qué no (por ejemplo, a la hora de crear un ejercicio nuevo).",
  "tutorial.s3.step4":
