...
export const es = {
  ...
  "language.warning.body":
    "Las variantes que ya has generado, los temarios construidos y las sesiones de evaluación se quedan como están: se escribieron en el idioma del espacio de trabajo y no se traducen.",
  ...
  "profileEditor.savesOnApprove": "se guardan al aprobar, arriba",
