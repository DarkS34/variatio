...
export const es = {
  ...
  "account.whatIsHere.body":
    "Tu cuenta y lo que es tuyo: los datos con los que entras, las variantes que has generado y las asignaturas a las que tienes acceso. Nada de esto es uno de los cuatro pasos, por eso no está en la barra de arriba.",
  ...
  "bank.orderByDifficulty": "Ordenar por dificultad",
  ...
  "modality.difficulty.hint": "Todos los tipos usan estos tres niveles: así «avanzado» significa lo mismo en toda la lista y puedes ordenarla por dificultad. Lo que cambia de un tipo a otro es qué hace que un ejercicio caiga en cada uno, y eso es lo que escribes aquí. Di, para cada nivel, en qué se le nota: qué pide, cuántos pasos encadena, cuánto hay que combinar. La escala se mide contra tus propios ejercicios, no contra la asignatura ideal.",
