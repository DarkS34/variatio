...
def delete_evaluator_records(
    ...
    """Remove everything these evaluators contributed to the study, both instruments.

    The comparisons they hold and the forms they answered go together, because a person
    withdrawn from the study is withdrawn from all of it — keeping their forms while
    dropping their comparisons would leave half a contribution nobody asked for. The
    ACCOUNT is untouched: this is the study's data, not the installation's access.
    """
