...
The only stage that imports `builders/`, which is what keeps Docling and torch out of every
other import path. A build writes exactly one artifact, and always the `_autogenerated`
